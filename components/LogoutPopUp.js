...
const LogoutPopUp = ( { isLogout, setIsLogout } ) => {
    ...
    return (
        <div className=" h-screen w-screen bg-transparent backdrop-blur-sm fixed left-0 top-0 inset-0 z-50  flex justify-center items-center">
            <div className="h-[20%] w-[80%] md:h-[25%] md:w-[30%] flex flex-col justify-center gap-7 items-center rounded-lg text-gray-200 bg-[#2d2e33]">
                <div className="head w-full flex flex-col items-center gap-2">
                    ...
                    <p className="pl-9">Log out from Lernova as {email} ?</p>
                </div>
